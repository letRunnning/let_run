<?php
    ...
    if($uploadcode){
        ...
        if ($r) {
            $sql = "INSERT INTO `files`(`no`, `name`, `original_name`, `path`, `create_time`, `usable`) VALUES (null,'$imageName','$imageName','http://running.im.ncnu.edu.tw/running/files/photo/staff/',now(),1);";
