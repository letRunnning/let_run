<?php
class CourseAttendanceModel extends CI_Model {
  /*
   * create course
   */
  function create_one($course, $member, $startTime, $endTime, $duration, $isInsurance, $insuranceStartDate, $insuranceEndDate, $note) {
    $obj = (object)[
      'course' => $course,
      'member' => $member,
  ...
  function delete_by_no($startTime, $organization) {
  ...
  function get_by_organization_youthName($organization, $yearType) {
