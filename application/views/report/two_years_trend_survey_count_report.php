              ...
              <label for="name">執行單位</label>
					...
					<div class="row justify-content-center">
						<div class="col-sm-10 col-md-8">
							...
							<textarea required id="note" class="form-control" name="note" style="height: 100px" <?php echo ($twoYearsTrendSurveyCountReports) ? '' : '' ?>><?php echo (empty($twoYearsTrendSurveyCountReports)) ? $noteDetail : $twoYearsTrendSurveyCountReports->note ?></textarea>
						</div>
					</div>
