		  ...
		  <?php $this->load->view('report/templates/month_report_track_table');?>
					...
					<!-- <div class="row justify-content-center">
						<div class="col-sm-10 col-md-8">
							...
							<textarea required id="note" class="form-control" name="note" style="height: 100px"<?php echo ($oldCaseTrendSurveyCountReports) ? '' : '' ?>><?php echo (empty($oldCaseTrendSurveyCountReports)) ? $noteDetail : $oldCaseTrendSurveyCountReports->note ?></textarea>
						</div>
					</div> -->
					...
					<a class="btn col s2 offset-s5 waves-effect blue darken-4" href="<?php echo site_url('report/old_case_trend_survey_count_report_organization_table/' . $yearType . '/' . $monthType); ?>">預覽縣市承辦人端</a>
