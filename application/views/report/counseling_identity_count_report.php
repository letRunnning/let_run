		...
		<div class="card-body col-sm-12">
			...
			<div class="card-content">
				...
				<form action="<?php echo site_url($url); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
					...
					<h3><?php if (isset($get_inserted_identity_count_data)) {
							// echo "EDIT".$county;
            ...
            <div class="input-field col s10 offset-m2 m8">
              <select name="years" id="years" onchange="location = this.value;">
                ...
                <?php foreach ($years as $i) { ?>
                  <option <?php echo ($yearType == ($i['year'])) ? 'selected' : '' ?> value="<?php echo site_url('/report/counseling_identity_count_report/' . $i['year'] . '/' . $monthType); ?>"><?php echo $i['year'] ?></option>
                <?php } ?>
            ...
            <div class="input-field col s10 offset-m2 m8">
              <select name="months" id="months" onchange="location = this.value;">
                ...
                <?php foreach ($months as $i) { ?>
                  ...
                  <option <?php echo ($monthType == $i) ? 'selected' : '' ?> value="<?php echo site_url('/report/counseling_identity_count_report/' . $yearType . '/' . $i); ?>"><?php echo $i ?></option>
                <?php } ?>
