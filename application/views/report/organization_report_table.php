...
<div class="container" style="width:90%;">
      ...
      <div class="card-content">
        ...
        <div class="row justify-content-center">
            ...
            <select class="form-select form-select-lg" name="reportType" id="reportType" onchange="location = this.value;">
              ...
              <option <?php echo ($reportType == 'memberCounseling') ? 'selected' : '' ?> value="<?php echo site_url($url . 'memberCounseling/' . $yearType); ?>">學員輔導清單</option>
              ...
              <option <?php echo ($reportType == 'reportOneRealTime') ? 'selected' : '' ?> value="<?php echo site_url($url . 'reportOneRealTime/' . $yearType); ?>">輔導與關懷追蹤統計表</option>
              <option <?php echo ($reportType == 'reportTwoRealTime') ? 'selected' : '' ?> value="<?php echo site_url($url . 'reportTwoRealTime/' . $yearType); ?>">關懷追蹤青少年動向調查追蹤表(108國中與109高中)</option>
            </select>
          </div>
        </div>
        ...
        <?php if($reportType == 'all'){?>
          <div class="row justify-content-center">
						<div class="col-sm-3">
							<a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'all' . '/' . $yearType); ?>">列印全部(下載excel檔)</a><br /><br />
						</div>
					</div>
        <?php }?>
        ...
        <!-- <a class="btn btn-success" onclick="exportTableToCSV('.countyDelegateOrganization', '各縣市各年度計畫清單.csv')">列印(下載excel檔)</a><br/><br/> -->
        <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'countyDelegateOrganization' . '/' . $yearType); ?>">列印(下載excel檔)</a>
        <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'countyDelegateOrganization' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
    ...
    if ($value['no'] == $i['executeWay']) {
        ...
        <table class="memberCounseling table table-hover table-bordered align-middle text-center" style="border:2px grey solid;">
          ...
          <tbody>
					<?php foreach ($memberCounselings as $i) {?>
						<tr>
              ...
              <td><?php echo $i['groupCounselingHour'] ?></td>
              <td><a href="<?php echo site_url('/course/get_course_attendance_table_by_member/' . $i['no']); ?>"><?php echo $i['courseAttendanceHour'] ?></td>
              <td><a href="<?php echo site_url('/work/get_work_attendance_table_by_member/' . $i['no']); ?>"><?php echo $i['workAttendanceHour'] ?></td>
						</tr>
					<?php }?>
          </tbody>
        </table>
        ...
        <h4>輔導成效統計表</h4>
        <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffection', '輔導成效統計表.csv')">列印(下載excel檔)</a> <br/><br/> -->
        <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffection' . '/' . $yearType); ?>">列印(下載excel檔)</a>
        <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffection' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
        ...
        <?php if ($reportType == 'counselEffectionIndividual' || $reportType == 'all') {?>
          <h4>個別輔導時數統計表</h4>
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffectionIndividual', '個別輔導時數統計表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionIndividual' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionIndividual' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
     ...
     + $i['judicialServiceCount'] + $i['healthServiceCount'] + $i['otherServiceCount'] : null ?></td>
        ...
        <?php if ($reportType == 'counselEffectionGroup' || $reportType == 'all') {?>
          <h4>團體輔導時數統計表</h4>
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffectionGroup', '團體輔導時數統計表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionGroup' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionGroup' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
     ...
     + $i['judicialServiceCount'] + $i['genderServiceCount'] + $i['professionServiceCount'] + $i['volunteerServiceCount'] + $i['otherServiceCount'] : null ?></td>
        ...
        <?php if ($reportType == 'counselEffectionCourse' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffectionCourse', '生涯探索課程或活動時數統計表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionCourse' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionCourse' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
        ...
        <?php if ($reportType == 'counselEffectionWork' || $reportType == 'all') {?>
          <h4>工作體驗時數統計表</h4>
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffectionWork', '工作體驗時數統計表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionWork' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionWork' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
     ...
     + $i['hospitalWorkCount'] + $i['artWorkCount'] + $i['otherWorkCount'] : null ?></td>
        ...
        <?php if ($reportType == 'counselEffectionMeeting' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffectionMeeting', '跨局處會議及預防性講座統計表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionMeeting' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'counselEffectionMeeting' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
        ...
        <?php if ($reportType == 'surveyTypeOldCaseTrack' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeOldCaseTrack', '前一年度開案後動向調查追蹤表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeOldCaseTrack' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeOldCaseTrack' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
        ...
        <?php if ($reportType == 'surveyTypeTwoYears' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeTwoYears', '<?php echo $yearType - 4 ?>學年度國中畢業未升學未就業青少年動向調查表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeTwoYears' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeTwoYears' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
     ...
     + $i['surveyTypeNumberThirteen'] + $i['surveyTypeNumberThirteenOne'] + $i['surveyTypeNumberThirteenTwo'] + $i['surveyTypeNumberThirteenThree'] ?></td>
        ...
        <?php if ($reportType == 'surveyTypeOneYears' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeOneYears', '<?php echo $yearType - 3 ?>學年度國中畢業未升學未就業青少年動向調查表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeOneYears' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeOneYears' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
     ...
     + $i['surveyTypeNumberThirteen'] + $i['surveyTypeNumberThirteenOne'] + $i['surveyTypeNumberThirteenTwo'] + $i['surveyTypeNumberThirteenThree'] ?></td>
        ...
        <?php if ($reportType == 'surveyTypeNowYears' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeNowYears', '<?php echo $yearType - 2 ?>學年度國中畢業未升學未就業青少年動向調查表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeNowYears' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeNowYears' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
     ...
     + $i['surveyTypeNumberThirteen'] + $i['surveyTypeNumberThirteenOne'] + $i['surveyTypeNumberThirteenTwo'] + $i['surveyTypeNumberThirteenThree'] ?></td>
        ...
        <?php if ($reportType == 'surveyTypeHighSchoolTrack' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeHighSchoolTrack', '109年度高中已錄取未註冊青少年動向調查追蹤表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeHighSchoolTrack' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeHighSchoolTrack' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
          <?php $this->load->view('report/templates/report_track_table');?>
				<?php }?>
        ...
        <?php if ($reportType == 'surveyTypeTwoYearsTrack' || $reportType == 'all') {?>
          ...
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeTwoYearsTrack', '<?php echo $yearType - 4 ?>學年度國中畢業未升學未就業青少年動向調查追蹤表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeTwoYearsTrack' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeTwoYearsTrack' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
          <?php $this->load->view('report/templates/report_track_table');?>
				<?php }?>

        <?php if ($reportType == 'surveyTypeOneYearsTrack' || $reportType == 'all') {?>
          <h4><?php echo $yearType - 3 ?>學年度國中畢業未升學未就業青少年動向調查追蹤表</h4>
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeOneYearsTrack', '<?php echo $yearType - 3 ?>學年度國中畢業未升學未就業青少年動向調查追蹤表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeOneYearsTrack' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeOneYearsTrack' . '/' . $yearType. '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
          <?php $this->load->view('report/templates/report_track_table');?>
				<?php }?>

        <?php if ($reportType == 'surveyTypeNowYearsTrack' || $reportType == 'all') {?>
          <h4><?php echo $yearType - 2 ?>學年度國中畢業未升學未就業青少年動向調查追蹤表</h4>
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.surveyTypeNowYearsTrack', '<?php echo $yearType - 2 ?>學年度國中畢業未升學未就業青少年動向調查追蹤表.csv')">列印(下載excel檔)</a> -->
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeNowYearsTrack' . '/' . $yearType); ?>">列印(下載excel檔)</a>
          <a class="btn btn-success" href="<?php echo site_url('export/organization_report_export/' . 'surveyTypeNowYearsTrack' . '/' . $yearType . '/ods'); ?>">列印(下載ods檔)</a><br/><br/>
          <?php $this->load->view('report/templates/report_track_table');?>
				<?php }?>
