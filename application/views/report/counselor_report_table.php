    ...
    <div class="card-body col-sm-12">
      ...
      <div class="card-text">
        ...
        <!-- reportType -->
          ...
          <div class=" col-sm-10 col-md-8 mb-3">
            ...
            <select class="form-select form-select-lg" name="reportType" id="reportType" onchange="location = this.value;">
              ...
              <option <?php echo ($reportType == 'countyDelegateOrganization') ? 'selected' : '' ?> value="<?php echo site_url($url . 'countyDelegateOrganization/' . $yearType); ?>">縣市計畫資訊</option>
        ...
        <?php if ($reportType == 'all') { ?>
          <div class="row justify-content-center">
            <div class="col-sm-3">
              <a class="btn btn-success" href="<?php echo site_url('export/counselor_report_export/' . 'all' . '/' . $yearType); ?>">列印全部(下載CSV檔)</a><br /><br />
            </div>
          </div>
        <?php } ?>
            ...
            <tbody>
              <?php foreach ($memberCounselings as $i) { ?>
                <tr>
                  ...
                  <td><a href="<?php echo site_url('/member/get_individual_counseling_table_by_member/' . $i['no']); ?>"><?php echo $i['individualCounselingHour'] ?></a></td>
                  <td><a href="<?php echo site_url('/member/get_group_counseling_table_by_member/' . $i['no']); ?>"><?php echo $i['groupCounselingHour'] ?></td>
        ...
        <?php if ($reportType == 'counselEffection' || $reportType == 'all') { ?>
          <h4>輔導成效統計表</h4>
          <!-- <a class="btn btn-success" onclick="exportTableToCSV('.counselEffection', '輔導成效統計表.csv')">下載excel檔</a> <br/><br/> -->
          <a class="btn btn-success" href="<?php echo site_url('export/counselor_report_export/' . 'counselEffection' . '/' . $yearType); ?>">下載excel檔</a><br /><br />
