...
<html>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <script type="text/javascript">
      ...
      var pathPoints=[];
      for(i = 0; i < data.length; i++) {
        pathPoints.push([String(data[i].no),
...
<div class="row">
    ...
    <div class="col-10 m-2 mx-auto">
      ...
      <div class="col-10 m-2 mx-auto">
        <label for="target" class="form-label">請點選地圖中欲刪除之地標</label>
        <input class="form-control" type="text" id="target" name="target" value="" required placeholder="請點選地圖中欲刪除之地標">
      </div>
</div> 
      <div class="row">
