...
<div class="container">
  <div class="card">
    <div class="card-header" id="headingOne">
      <div class="row">
        <div class="col-8 text-left"><span class="fs-5">袁宫依</span></div>
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        <span class=''>姓名：</span><span>袁宫依</span><br>
  ...
  <div class="card">
    <div class="card-header" id="headingTwo">
      <div class="row">
        <div class="col-8 text-left"><span class="fs-5">袁宫貳</span></div>
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
      <div class="card-body">
        <span class=''>姓名：</span><span>袁宫貳</span><br>
  ...
  <div class="card">
    <div class="card-header" id="headingThree">
      <div class="row">
        <div class="col-8 text-left"><span class="fs-5">袁宫參</span></div>
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
      <div class="card-body">
        <span class=''>姓名：</span><span>袁宫參</span><br>
